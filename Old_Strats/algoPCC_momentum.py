    ...
    def __init__(self, assets = None, printing = True):
        if assets is None:
            assets = {
                ...
                "COCONUTS":Asset(600, 500, 10),
                "PINA_COLADAS":Asset(300, 500, 10),
            }
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'PINA_COLADAS':
                ...
                if position_PC == 0: value_PC =0
                if position_C == 0: value_C =0


                profit_PC = 0
                # buying at the ask price
                if position_PC<0:
                    profit_PC = profit_PC +value_PC + position_PC*best_ask_PC


                # selling at the bid price
                if position_PC>0:
                    profit_PC = profit_PC +position_PC*best_bid_PC +value_PC


                profit_C = 0
                # buying at the ask price
                if position_C<0:
                    profit_C = profit_C +value_C +position_C*best_ask_C

                # selling at the bid price
                if position_C>0:
                    profit_C = profit_C +position_C*best_bid_C +value_C
                ...
                if profit_PC>profit_thresh:
                    print('start profit liquidation PC')
                ...
                if profit_C>profit_thresh:
                    print('start profit liquidation C')
                    ...
                    if position_C<0:
                        ...
                        position_C = position_C+order_size_C
                    self.last_trade_time =0
                    print('end profit liquidation C')



                if profit_PC<-loss_thresh:
                    print('start loss liquidation PC')
                    # print('Last Trade for Pina Coladas (P,V):', last_trade_PC, last_trade_volume_PC)
                    # print('Last Trade for Coconuts (P,V):', last_trade_C, last_trade_volume_C)
                    # sell if positive position
                    if position_PC>0:
                    ...
                    if position_PC<0:
                        ...
                        orders_PC.append(Order('PINA_COLADAS', best_ask_PC, order_size_PC))
                        position_PC = position_PC+order_size_PC
                    print('end loss liquidation PC')

                if profit_C<-loss_thresh:
                    print('start loss liquidation C')
                    # sell if posititive position
                    if position_C>0:
                        order_size_C = min(best_bid_volume_C, 0+position_C)
                        print("SELL", 'COCONUTS', str(order_size_C) + "x", best_bid_C)
                ...
                if len(assets[product].ask_prices)>=assets[product].period:
                    ...
                    if fast_avg_PC > best_ask_PC:
                        ...
                        if fast_avg_C > best_ask_C:
                            ...
                            value_PC = value_PC + best_bid_PC*order_size_PC
                            value_C  = value_C  + best_bid_C*order_size_C
                        ...
                        #     value_PC = value_PC - best_ask_PC*order_size_PC
                        #     value_C  = value_C  + best_bid_C*order_size_C
                    ...
                    if fast_avg_PC < best_bid_PC:
                        ...
                        if fast_avg_C < best_bid_C:
                            ...
                            value_PC = value_PC - best_ask_PC*order_size_PC
                            value_C  = value_C  - best_ask_C*order_size_C
